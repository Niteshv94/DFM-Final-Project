...
public class ValidateNewDiagramAndObjects {
	...
	public void setUpReport() {
		...
		sparkReporter = new ExtentSparkReporter(new File(System.getProperty("user.dir")
				+ "./Reports/Projects/DFM_AddDiagram_" + Helper.getCurrentDateTime() + ".html"));
...
//		driver = new EdgeDriver();
	...
	@Test (priority = 1)
	public static void loginToDfmApplication() throws InterruptedException, IOException {

		// reports.createTest("Login");
		Reporter.log("Test Case for Add Diagram");
...
//				MediaEntityBuilder.createScreenCaptureFromPath("./Screenshots/screenshot.png").build());
		...
		extentTest.pass("Navigate to DFM URL");
...
//		}
	...
	public static void addAndValidateProject() throws InterruptedException, IOException {
		...
		extentTest.pass("Entered Project Name");
		...
		extentTest.pass("Entered Project Description");
		...
		Thread.sleep(5000);
		extentTest.pass("Clickd on Add Project button");
		...
		extentTest.pass("Clicked on Add Tag");
		...
		Thread.sleep(2000);
		extentTest.pass("Clicked on Create DRD button");
		...
		Thread.sleep(5000);
		extentTest.pass("Clicked on Add Diagram button");
		...
		extentTest.pass("Object Dragged and Validated");
