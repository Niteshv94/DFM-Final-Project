...
public class MultiUserDeleteTag02 {
...
//		extentTest.pass("Clicked on Add Tag button");
	...
	public void validateTag() throws InterruptedException, IOException {
		...
		XSSFSheet sheet = workbook.getSheet("AddTagTest");
		String searchProject = sheet.getRow(1).getCell(0).getStringCellValue();
		String xpathverifyTag = sheet.getRow(5).getCell(2).getStringCellValue();
...
//		if (element) {
//
//			System.out.println("The Update Tag is Present in the Project...");
//		} else {
//
//			System.out.println("The Update Tag is not Present in the Project...");
//		}
		
		//Verify the Customer is present or not
				List<WebElement> verify_tag_inList = driver.findElements(By.xpath(xpathverifyTag));
				if (verify_tag_inList.size() > 0) {
					System.out.println("The tag is not deleted... Please try again later");

				} else {
					System.out.println("Congratulations, The tag is deleted from the Project...");
