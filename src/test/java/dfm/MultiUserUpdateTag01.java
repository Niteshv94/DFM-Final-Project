...
public class MultiUserUpdateTag01 {
...
//						MediaEntityBuilder.createScreenCaptureFromPath("./Screenshots/screenshot.png").build());
	...
	public void addTag() throws InterruptedException, IOException {
		...
		String xpathUpdateTag = sheet.getRow(5).getCell(0).getStringCellValue();
...
//				.click();
		...
		driver.findElement(By.xpath("//div[contains(text(),'Edit Tag')]")).click();
		Thread.sleep(2000);

		driver.findElement(By.xpath("//*[@id=\"name\"]/quill-editor/div[2]/div[1]/p")).clear();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"name\"]/quill-editor/div[2]/div[1]/p")).sendKeys(updateName);
